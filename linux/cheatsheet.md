...
inotifywait --event modify,create,delete,move --monitor --recursive ~/ @/home/$USER/{.config/Code,.config/mozilla/firefox,.cache/mozilla} @/home/$USER/.local/share/AyuGramDesktop
```
